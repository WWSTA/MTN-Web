(function initNanoReaderBrowserModelStore(globalScope) {
  ...
  // Use hf-mirror.com (domestic mirror) so users in China can download the
  // fallback models without needing a VPN to reach huggingface.co directly.
  const HF_API_BASE = 'https://hf-mirror.com/api/models/';
  const HF_RESOLVE_BASE = 'https://hf-mirror.com/';
  const MODEL_REPOS = [
    {
